...
class TerminalTestAufgabe1 {
    ...
    fun testNeueContainer() {
        ...
        Assert.assertFalse(cont1.isStable)
    ...
    fun testEinAusliefern() {
        ...
        Assert.assertEquals(9, terminal.freieKapazitaet)
        Assert.assertEquals(3, terminal.anzahlBewegungen)
    ...
    fun testGebuehren() {
        ...
        /* aktuelle Geb�hren f�r einzelne Container und gesamt */
        Assert.assertEquals(fix + 52 * rate, terminal.getGebuehren(c1.id), 0.001)
        Assert.assertEquals(fix + 1 * rate, terminal.getGebuehren(c2.id), 0.001)
        Assert.assertEquals(2 * fix + 53 * rate, terminal.gebuehren, 0.001)
         ...
         */
        Assert.assertEquals(fix + 52 * rate, terminal.getGebuehren(c1.id), 0.001)
        Assert.assertEquals(fix + 2 * rate, terminal.getGebuehren(c2.id), 0.001)
        Assert.assertEquals(2 * fix + 54 * rate, terminal.gebuehren, 0.001)
    }
}