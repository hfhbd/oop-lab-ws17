...
class TerminalTestAufgabe2 {
     ...
     * belade-Methode, zum Abladen die entlade-Methode. */
        ...
        Assert.assertFalse(lastzug.enthaelt(cont1.id))
        Assert.assertFalse(lastzug.enthaelt(cont2.id))
        Assert.assertFalse(lastzug.enthaelt(cont3.id))
        ...
        Assert.assertTrue(lastzug.enthaelt(cont1.id))
        Assert.assertFalse(lastzug.enthaelt(cont2.id))
        Assert.assertFalse(lastzug.enthaelt(cont3.id))
     ...
     */
        ...
        Assert.assertTrue(cont1.isStable)
