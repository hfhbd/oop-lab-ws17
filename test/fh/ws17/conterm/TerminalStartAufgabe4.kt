...
class TerminalStartAufgabe4 : Application() {
    ...
    override fun start(arg0: Stage) {
        ...
        var v1 = View(TerminalController(terminal))
        v1.start(Stage())

        //Doppelte View zum Sync testen
        v1 = View(TerminalController(terminal))
        v1.start(Stage())

        val v2 = View(TransporterController(lkw1))
        v2.start(Stage())

        val v3 = View(TransporterController(lkw2))
        v3.start(Stage())

        val v4 = View(TransporterController(kahn))
        v4.start(Stage())
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            launch(TerminalStartAufgabe4::class.java)
        }
    }
